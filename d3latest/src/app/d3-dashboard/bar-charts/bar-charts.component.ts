...
export class BarChartsComponent implements OnInit {
    ...
    getRatioForTransForm(side: any) {
        return ((this.margin[side] / this.width) * 100);
    }

    resize(event: any) {
        //here 150 is the gap between the offsetWidth and maxmized window
        this.width = document.getElementById('chart').offsetWidth+150;
    ...
    drawGraph() {
        ...
        var transform = 'translate(' + self.getRatioForTransForm("left") + "," + self.getRatioForTransForm("top") + ')';
